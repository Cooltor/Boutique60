...
<?php 
            ...
            if(isset($_GET['action']) && $_GET['action'] == 'affichage'){
              $onceCat = $pdo->query("SELECT * FROM produit WHERE categorie = '$_GET[categorie]'");
                ...
                <div class=\"card\" style=\"width: 30%; margin-bottom: 1rem; margin-right: 1rem;\">
                    <a href=\"?action=pageproduit&id_produit=$all[id_produit]\" style=\"cursor: pointer;\">  
                    ...
                    <ul class=\"list-group list-group-flush\">
                        <li class=\"list-group-item\">$all[prix] €</li>
            ...
            echo "
                <div class=\"card text-truncate\" style=\"width: 30%; margin-bottom: 1rem; margin-right: 1rem;\">
                <a href=\"?action=pageproduit&id_produit=$all[id_produit]\" style=\"cursor: pointer;\">  
                <img src=\"$all[photo]\" class=\"card-img-top\" alt=\"...\">
